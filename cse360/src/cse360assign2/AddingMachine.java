...
public class AddingMachine {
	...
	public void add (int value) //method used to add the values together into total
	{
		...
		operations = operations +" + " + value; //saving  the operations performed into the string variable operations
	}
	...
	{
		operations = "0";//reseting operations back to 0 to be used for new operations
	}
